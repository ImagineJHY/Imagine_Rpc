...
RpcServiceMethodTypeParseEndState::RpcServiceMethodTypeParseEndState(StateMachineState* const parent_state, StateMachine* sm) : ServiceGeneratorStateMachineState(RPCSERVICE_METHOD_TYPE_PARSE_END_STATE_NAME, parent_state, sm)
{
}

RpcServiceMethodTypeParseEndState::~RpcServiceMethodTypeParseEndState()
{
}

void RpcServiceMethodTypeParseEndState::Init()
{
    this->RegisterTransitionEventCallback(PARSE_SYMBOL_EVENT_NAME, static_cast<size_t>(StateEventPriority::LevelFourPriority), std::bind(&RpcServiceMethodTypeParseEndState::ParseSymbolCondition, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3), sm_->GetStatePtr(RPCSERVICE_METHOD_PARSE_END_STATE_NAME), nullptr);
...
bool RpcServiceMethodTypeParseEndState::ParseSymbolCondition(StateMachineState* src, StateMachineState* tgt, StateMachineEvent evt)
{
...
StateMachineState* RpcServiceMethodTypeParseEndState::onEnter()
{
    return this;
}

StateMachineState* RpcServiceMethodTypeParseEndState::onExit()
{
    return this;
}
